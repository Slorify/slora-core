...
export type GetDomainAggregateType<T extends DomainAggregateArgs> = {
    [P in keyof T & keyof AggregateDomain]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateDomain[P]> : Prisma.GetScalarType<T[P], AggregateDomain[P]>;
};
...
type GetDomainGroupByPayload<T extends DomainGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<DomainGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof DomainGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], DomainGroupByOutputType[P]> : Prisma.GetScalarType<T[P], DomainGroupByOutputType[P]>;
}>>;
...
export type DomainScalarWhereWithAggregatesInput = {
    ...
    port?: Prisma.IntWithAggregatesFilter<"Domain"> | number;
    instanceId?: Prisma.IntWithAggregatesFilter<"Domain"> | number;
};
export type DomainCreateInput = {
    name: string;
    domain: string;
    port?: number;
    instances: Prisma.InstanceCreateNestedOneWithoutDomainsInput;
};
...
export type DomainUpdateInput = {
    ...
    instances?: Prisma.InstanceUpdateOneRequiredWithoutDomainsNestedInput;
};
...
export type DomainUncheckedCreateWithoutInstancesInput = {
    id?: number;
    name: string;
    domain: string;
    port?: number;
};
export type DomainCreateOrConnectWithoutInstancesInput = {
...
export type DomainOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "domain" | "port" | "instanceId", ExtArgs["result"]["domain"]>;
...
export type DomainCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<DomainFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DomainDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends DomainCountArgs>(args?: Prisma.Subset<T, DomainCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], DomainCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends DomainGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, DomainGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDomainGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface DomainFieldRefs {
    ...
    readonly port: Prisma.FieldRef<"Domain", 'Int'>;
    readonly instanceId: Prisma.FieldRef<"Domain", 'Int'>;
}
/**
 * Domain findUnique
 */
