...
// @ts-nocheck 
/*
 * This file exports the `GithubApp` model and its related types.
 *
...
export type GetGithubAppAggregateType<T extends GithubAppAggregateArgs> = {
      [P in keyof T & keyof AggregateGithubApp]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateGithubApp[P]>
    : Prisma.GetScalarType<T[P], AggregateGithubApp[P]>
}
...
type GetGithubAppGroupByPayload<T extends GithubAppGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<GithubAppGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof GithubAppGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], GithubAppGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], GithubAppGroupByOutputType[P]>
      }
    >
  >
...
export type GithubAppCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<GithubAppFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GithubAppDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['GithubApp'], meta: { name: 'GithubApp' } }
  /**
   ...
   * })
  **/
  count<T extends GithubAppCountArgs>(
    args?: Prisma.Subset<T, GithubAppCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], GithubAppCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends GithubAppGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, GithubAppGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGithubAppGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
