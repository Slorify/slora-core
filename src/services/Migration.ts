...
class Migration {
  async migrateToSwarm(): Promise<void> {
  ...
  async migrateToCompose(): Promise<void> {
  ...
  private async stopComposeServices(): Promise<void> {
  ...
  private async recreateNetworkForSwarm(): Promise<void> {
    try {
  ...
  private async recreateNetworkForCompose(): Promise<void> {
    try {
      await runCmd(`docker network rm ${NETWORKS.proxy}`, "migration");
    } catch {}
  ...
  private async removeAllStacks(): Promise<void> {
    try {
  ...
  private async deployAsStacks(containers: string[]): Promise<void> {
  ...
  private async startWithCompose(services: string[]): Promise<void> {
  ...
  private async checkSwarmStatus(): Promise<boolean> {
    try {
